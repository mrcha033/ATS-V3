...
// Import types from shared namespace
using ats::types::TradeSignal;
using ats::types::Position;
...
// Note: TradeSignal and Position are now imported from ats::types namespace
...
private:
    ...
    double apply_slippage(double target_price, ats::types::SignalType signal_type);
...
// InsufficientDataException already defined in performance_metrics.hpp
